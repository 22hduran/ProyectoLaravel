<x-app-layout>
    ...
    <div class="py-12 flex items-center justify-center w-full h-full">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8 mt-24">
            <div class="bg-white dark:bg-gray-200 overflow-hidden sm:rounded-lg border border-solid border-black shadow-lg ">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('comenzar-jornada') }}" method="POST" class="ml-16">
                        @csrf
                        <button type="submit" class="bg-white text-gray-900 dark:bg-white dark:text-black font-bold py-2 px-4 rounded border border-solid border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-300 hover:border-gray-400 dark:hover:border-black transition duration-300 ease-in-out shadow-xl m-2">
                            COMENZAR JORNADA
                        </button>
                    </form>
                </div>
